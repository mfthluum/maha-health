        ...
        <div class="row auth-container overflow-hidden rounded-3xl glass-card border-0">
            ...
            <div class="col-lg-6 left-panel bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 text-white p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="my-auto py-6 relative z-10 text-center flex flex-col items-center">
                    ...
                    <!-- CONTAINER LOGO ICONIC JAUH LEBIH BESAR -->
                    ...
                    <p class="text-emerald-100/90 text-xs lg:text-sm leading-relaxed max-w-sm mx-auto">
                        Pantau kesehatan harianmu melalui 
                        <strong class="text-white font-bold">Digital Twin</strong>, 
                        skor medis akurat, serta rekomendasi gaya hidup yang dipersonalisasi.
                    </p>
                </div>
            ...
            <div class="col-lg-6 right-panel bg-white p-8 lg:p-12 flex flex-col justify-center">
                ...
                <div class="auth-card max-w-md mx-auto w-full">
                    ...
                    <!-- Form Login -->
                    <form action="login_process.php" method="POST" onsubmit="return validateLogin()" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="email"
                                name="email"
                                class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-xs sm:text-sm outline-none text-slate-800 placeholder-slate-400"
                        ...
                        <div class="flex items-center justify-between text-xs pt-1">
                            <label class="flex items-center space-x-2 text-slate-600 cursor-pointer">
                                <input
                                    type="checkbox"
                                    name="remember"
                                    class="w-4 h-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500/20">
                                <span>Ingat Saya</span>
                            </label>
                           <a href="forgot_password.php" class="text-emerald-600 hover:text-emerald-700 font-bold hover:underline transition">
                              Lupa Password?
                        </a>
                        </div>
                    ...
                    <!-- Link Register -->
                    <div class="register-link text-center text-xs text-slate-500 mt-8 pt-6 border-t border-slate-100">
                        Belum punya akun?
                        <a href="register.php" class="text-emerald-600 hover:text-emerald-700 font-extrabold hover:underline ml-1">
                            Daftar Sekarang
                        </a>
                    </div>
